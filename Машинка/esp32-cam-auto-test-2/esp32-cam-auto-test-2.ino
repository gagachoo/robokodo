...
Машинка с камерой с сайта:
  https://habr.com/ru/articles/574156/
  Видео хорошо работает на телефоне но не работает на компе
  !!!!!!
  работает на библиотете 1.0.6 - на более поздних не работает,
   выдаёт ошибку об отсутствии библиотеки dl_lib_matrix3d.h
*/
...
const char* ssid1 = "RT-WiFi-B9DE";
const char* password1 = "UfX2Ceb5";
String sta_ssid = "";// "RT-WiFi-B9DE";     // set Wifi network you want to connect to
String sta_password = ""; //"UfX2Ceb5";   // set password for Wifi network
